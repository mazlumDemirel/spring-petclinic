...
public class EightQueensExample {
	 ...
	 * (In other words all rows in board have board.length columns.), all elements of board == 'q'
	 * or '.'. 'q's represent queens, '.'s represent open spaces.<br>
	 * <p>post: return true if the configuration of board is safe,
	 * that is no queen can attack any other queen on the board. false otherwise.
	 *
	 * @param board the chessboard
	 * @return true if the configuration of board is safe, that is no queen can attack any other
	 * queen on the board. false otherwise.
	 */
